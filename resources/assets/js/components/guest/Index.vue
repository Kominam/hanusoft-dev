<template lang="html">
      ...
      <ul>
        <li data-transition="fade" data-slotamount="10" data-masterspeed="300">
          ...
          <div class="tp-caption sft stb visible-lg"
            ...
            data-speed="300"
            data-start="1000"
            data-easing="easeOutExpo"><img src="/user/img/slides/slide-title-border.png" alt=""></div>
  ...
  <div class="container">
    <div class="row center">
      <div class="col-md-12">
        <img src="/user/img/slides/hs-slider2.jpg" class="img-responsive" data-appear-animation="fadeInUp" alt="hanusoft progress" style="margin: 45px 0px -35px;">
      </div>
    </div>
  </div>
              ...
              <div class="owl-carousel push-bottom" data-plugin-options='{"items": 1}'>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="testimonial-author">
                      <div class="img-thumbnail img-thumbnail-small">
                        <img src="/user/img/founder.jpg" alt="" width="120px" height="120px">
                      </div>
                ...
                <div>
                  <div class="col-md-12">
                    ...
                    <div class="testimonial-author">
                      <div class="img-thumbnail img-thumbnail-small">
                        <img src="user/img/founder.jpg" alt="">
                      </div>
                      <p><strong>Trinh Bao Ngoc</strong><span>FIT - Vice</span></p>
                    </div>
                  </div>
...
<section class="parallax" data-stellar-background-ratio="0.5" style="background-image: ''/user/img/parallax-image.jpg';">
  <div class="container">
    <div class="row center">
      <div class="col-md-12 center">
        ...
        <div class="row">
          <div class="owl-carousel testimonials" data-plugin-options='{"items": 1}'>
            <div>
              <div class="col-md-12">
                <img src="/user/img/clients/client-1.jpg" class="img-responsive img-circle" alt="">
...
<div class="container">
  ...
  <div class="row center push-top">
    <div class="owl-carousel" data-plugin-options='{"items": 6, "autoplay": true, "autoplayTimeout": 3000}'>
      <div>
        <img class="img-responsive" src="/user/img/partner/codelover.png" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/fsoft.jpg" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/hackademic hanoi.png" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/ibm-logo.jpg" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/IFS.png" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/it japan.png" alt="">
      </div>
      <div>
        <img class="img-responsive" src="/user/img/partner/smartosc.png" alt="">
      </div>
    </div>
  </div>
</div>
<section class="call-to-action featured footer">
  <div class="container">
    <div class="row">
      <div class="center">
        <h3>Hanusoft is <strong>everything</strong> you need to create an <strong>awesome</strong> website! <a href="#" target="_blank" class="btn btn-lg btn-primary" data-appear-animation="bounceIn">Contact us Now!</a> <span class="arrow hlb hidden-xs hidden-sm hidden-md" data-appear-animation="rotateInUpLeft" style="top: -22px;"></span></h3>
      </div>
    </div>
  </div>
</section>
