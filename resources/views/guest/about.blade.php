...
<div class="main" role="main">
    ...
    <div class="container">
        <h2 class="word-rotator-title">
            Hanusoft will give you a chance to
            <strong>
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <a class="btn btn-lg btn-primary push-top" href="{{ route('login.showLoginForm') }}">
                    Join with us !!!
                </a>
            </div>
        </div>
                    ...
                    <div class="col-md-12">
                        <ul class="history">
                            <li data-appear-animation="fadeInUp">
                                <div class="thumb">
                                    <img alt="" src="{{url('frontend/img/develop-p3.jpg')}}"/>
                                </div>
                                <div class="featured-box">
                                    <div class="box-content">
                                        ...
                                        <p>
                                            In 2016, we continue to finish FIT portal project also recieve other project to gain mỏe experiences. the iportance thing is organize new recruiment to have new Hanusoft generations  .
                                        </p>
                            ...
                            <li data-appear-animation="fadeInUp">
                                <div class="thumb">
                                    <img alt="" src="{{url('frontend/img/develop-p2.jpg')}}"/>
                                </div>
                                <div class="featured-box">
                                    <div class="box-content">
                                        <h4>
                            ...
                            <li data-appear-animation="fadeInUp">
                                <div class="thumb">
                                    <img alt="" src="{{url('frontend/img/develop-p1.jpg')}}"/>
                                </div>
                                <div class="featured-box">
                                    <div class="box-content">
                                        <h4>
