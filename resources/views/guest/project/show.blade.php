        ...
        <div class="portfolio-title">
            <div class="row">
                <div class="portfolio-nav-all col-md-1">
                    <a data-original-title="Back to list" data-tooltip="" href="portfolio-single-project.html">
                        <i class="fa fa-th">
                        </i>
                    </a>
                </div>
                ...
                <div class="portfolio-nav col-md-1">
                    <a class="portfolio-nav-prev" data-original-title="Previous" data-tooltip="" href="portfolio-single-project.html">
                        <i class="fa fa-chevron-left">
                        </i>
                    </a>
                    <a class="portfolio-nav-next" data-original-title="Next" data-tooltip="" href="portfolio-single-project.html">
        ...
        <hr class="tall">
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <span class="arrow hlb" data-appear-animation="rotateInUpLeft" data-appear-animation-delay="800">
                    </span>
        ...
        <div class="row">
            <div class="center">
                <h3>
                    ...
                    website!
                    <a class="btn btn-lg btn-primary" data-appear-animation="bounceIn" href="http://themeforest.net/item/Hanusoft-responsive-html5-template/4106987" target="_blank">
                        Buy Now!
                    </a>
