                    ...
                    <article class="post post-large blog-single-post">
                            ...
                            <div class="owl-carousel" data-plugin-options='{"items":1}'>
                                <div>
                                    <div class="img-thumbnail">
                                        <img alt="" class="img-responsive" src="img/blog/blog-image-1.jpg">
                                        </img>
                                    </div>
                                </div>
                                <div>
                                    <div class="img-thumbnail">
                                        <img alt="" class="img-responsive" src="img/blog/blog-image-2.jpg">
                                        </img>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="post-content">
                            ...
                            <div class="post-block post-share">
                                ...
                                <script src="../../../s7.addthis.com/js/300/addthis_widget.js#pubid=xa-50faf75173aadc53" type="text/javascript">
                                </script>
                                <!-- AddThis Button END -->
                            </div>
                            ...
                            <div class="post-block post-comments clearfix">
                                ...
                                <ul class="comments">
                                    <li>
                                        <div class="comment">
                                            <div class="img-thumbnail">
                                                <img alt="" class="avatar" src="img/avatar-2.jpg">
                                                </img>
                                            </div>
                                        ...
                                        <ul class="comments reply">
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail">
                                                        <img alt="" class="avatar" src="img/avatar-3.jpg">
                                                        </img>
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-arrow">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="img-thumbnail">
                                                        <img alt="" class="avatar" src="img/avatar-4.jpg">
                                                        </img>
                                                    </div>
                                                    <div class="comment-block">
                                                        <div class="comment-arrow">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="img-thumbnail">
                                                <img alt="" class="avatar" src="img/avatar.jpg">
                                                </img>
                                            </div>
                                            <div class="comment-block">
                                                <div class="comment-arrow">
                            ...
                            <div class="post-block post-leave-comment">
                                ...
                                <form action="#" method="post">
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-6">
                                                ...
                                                <input class="form-control" id="name" maxlength="100" name="name" type="text" value="">
                                                </input>
                                            </div>
                                            <div class="col-md-6">
                                                <label>
                                                ...
                                                <input class="form-control" id="email" maxlength="100" name="email" type="email" value="">
                                                </input>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" id="comment" maxlength="5000" name="comment" rows="10">
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <input class="btn btn-primary btn-lg" data-loading-text="Loading..." type="submit" value="Post Comment">
                                            </input>
                                        </div>
                                    </div>
                                </form>
